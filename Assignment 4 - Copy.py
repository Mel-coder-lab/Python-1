...
'''
import math
# math plug in libary : First it is inputted from the user in the input phase (4 lines), then the formula calculates in the processing section after they are done inputting.



# this is the input section  **0.5 means square root (sqrt)
x1 = float(input("Enter x1 coordinate: "))
y1 = float(input("Enter y1 coordinate: "))
x2 = float(input("Enter x2 coordinate: "))
y2 = float(input("Enter y2 coordinate: "))

# This is the processing section below
#distance = math.sqrt((x2-1x)**2
distance = ((x2 - x1)**2 + (y2 - y1)**2)**0.5

#The output is below


print('The distance between 2 points are :',distance)